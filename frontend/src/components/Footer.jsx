    ...
    <footer className="footer">
      ...
      <div className="legal">
        ...
        <div className="legal__links">
            ...
            <Link to={"https://www.instagram.com/ravi.io/"} target="_blank"><FaInstagram className="links-fopter"/></Link>
            <Link to={"https://wa.me/+919389968605"} target="_blank"><FaWhatsappSquare className="links-fopter"/></Link>
        </div>
      </div>
    </footer>
  );
